...
<template>
<v-app-bar app color="white" elevation="2" class="header-videos" height="70" sticky>
    <!-- Botón menú -->
    <v-btn 
      icon 
      @click="toggleSidebar" 
      class="header-videos__menu-btn"
      color="red"
      variant="text"
    >
    ...
    <!-- Logo y título -->
    <div class="header-videos__logo d-flex align-center">
    ...
    <!-- Buscador -->
    <div class="header-videos__search d-flex align-center">
      <v-text-field
        v-model="searchQuery"
        density="compact"
        variant="outlined"
        ...
        @input="handleSearch"
        class="header-videos__search-field"
    ...
    <div class="header-videos__profile-section">
      <v-btn 
        variant="text"
        to="/perfil"
        class="header-videos__profile-btn"
      >
        <UserAvatar
          v-if="usuarioActual"
...
@import "@/assets/sass/layout/HeaderVideos";
</style>