...
<template>
<v-app-bar app color="white" elevation="2" class="header-usuarios" height="70" sticky>
    <!-- Botón menú -->
    <v-btn 
      icon 
      @click="toggleSidebar" 
      class="header-usuarios__menu-btn"
      color="orange"
      variant="text"
    >
    ...
    <!-- Logo y título -->
    <div class="header-usuarios__logo d-flex align-center">
    ...
    <!-- Buscador -->
    <div class="header-usuarios__search d-flex align-center">
      <v-text-field
        v-model="searchQuery"
        density="compact"
        variant="outlined"
        ...
        @input="handleSearch"
        class="header-usuarios__search-field"
    ...
    <div class="header-usuarios__profile-section">
      <v-btn 
        variant="text"
        to="/perfil"
        class="header-usuarios__profile-btn"
      >
        <UserAvatar
          v-if="usuarioActual"
...
@import "@/assets/sass/layout/HeaderUsuarios";
</style>