...
class VideoService {
  ...
  async uploadCompleteVideo(
    ...
    try {
      ...
      const response = await axios.post('http://34.198.50.70:5000/api/Video/registrar', formData, {
        headers: {
  ...
  async getVideos(): Promise<any[]> {
    try {
      const response = await axios.get('http://34.198.50.70:5000/api/Video');
      return response.data;
    } catch (error: any) {
  ...
  async getVideoById(videoId: number): Promise<any> {
    try {
      const response = await axios.get(`http://34.198.50.70:5000/api/Video/${videoId}`);
      return response.data;
    } catch (error: any) {
  ...
  async getVideosByCourse(courseId: number): Promise<any[]> {
    try {
      const response = await axios.get(`http://34.198.50.70:5000/api/Video/curso/${courseId}`);
      return response.data;
    } catch (error: any) {
