...
class VideoService {
  ...
  async uploadCompleteVideo(
    ...
    try {
      ...
      const response = await axios.post('https://academiqapi.retocsv.es/api/Video/registrar', formData, {
        headers: {
  ...
  async getVideos(): Promise<any[]> {
    try {
      const response = await axios.get('https://academiqapi.retocsv.es/api/Video');
      return response.data;
    } catch (error: any) {
  ...
  async getVideoById(videoId: number): Promise<any> {
    try {
      const response = await axios.get(`https://academiqapi.retocsv.es/api/Video/${videoId}`);
      return response.data;
    } catch (error: any) {
  ...
  async getVideosByCourse(courseId: number): Promise<any[]> {
    try {
      const response = await axios.get(`https://academiqapi.retocsv.es/api/Video/curso/${courseId}`);
      return response.data;
    } catch (error: any) {
