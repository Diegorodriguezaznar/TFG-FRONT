...
export const useReporteStore = defineStore('reporte', () => {
  ...
  async function crearReporte(nuevoReporte: ReporteDTO) {
    ...
    try {
      ...
      const response = await fetch('https://academiqapi.retocsv.es/api/ReporteVideo', {
        method: 'POST',
        headers: {
  ...
  async function fetchReportesPorVideo(idVideo: number) {
    ...
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/ReporteVideo/video/${idVideo}`)
  ...
  async function verificarReporteExistente(idUsuario: number, idVideo: number) {
    ...
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/ReporteVideo/check?idUsuario=${idUsuario}&idVideo=${idVideo}`)
