...
export const useCursoStore = defineStore("curso", () => {
  ...
  async function fetchCursoById(idCurso: number) {
    ...
    try {
      ...
      const response = await fetch(`https://academiqapi.retocsv.es/api/Curso/${idCurso}`, {
        signal: controller.signal,
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
  ...
  async function createCurso(
    ...
    try {
      ...
      const response = await fetch("https://academiqapi.retocsv.es/api/Curso/crear", {
        method: "POST",
        headers: {
          "Accept": "application/json",
  ...
  async function updateCurso(updatedCurso: CursoDTO) {
    ...
    try {
      ...
      const response = await fetch(`https://academiqapi.retocsv.es/api/Curso/${updatedCurso.idCurso}`, {
        method: "PUT",
        headers: { 
          "Content-Type": "application/json",
          "Accept": "application/json"
