...
export const useCursoStore = defineStore("curso", () => {
  ...
  async function fetchAllCursos() {
    ...
    try {
      ...
      const response = await fetch("http://34.198.50.70:3000/api/Curso", {
  ...
  async function fetchCursoById(idCurso: number) {
    ...
    try {
      ...
      const response = await fetch(`http://34.198.50.70:3000/api/Curso/${idCurso}`, {
        signal: controller.signal,
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
  ...
  async function createCurso(
    ...
    try {
      ...
      const response = await fetch("http://34.198.50.70:3000/api/Curso/crear", {
        method: "POST",
        headers: {
          "Accept": "application/json",
  ...
  async function updateCurso(updatedCurso: CursoDTO) {
    ...
    try {
      ...
      const response = await fetch(`http://34.198.50.70:3000/api/Curso/${updatedCurso.idCurso}`, {
        method: "PUT",
        headers: { 
          "Content-Type": "application/json",
          "Accept": "application/json"
