...
export const useVideoStore = defineStore("video", () => {
  ...
  async function fetchAllVideosPaged(params: PaginationParams = {}): Promise<PagedResult<VideoDTO> | null> {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/Video/paged?page=${page}&pageSize=${pageSize}`,
        {
  ...
  async function fetchVideosByCursoPaged(
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/Video/curso/${idCurso}/paged?page=${page}&pageSize=${pageSize}`,
        {
          signal: controller.signal,
          headers: {
            Accept: "application/json",
  ...
  async function fetchVideosByCurso(idCurso: number) {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/Video/curso/${idCurso}`,
        {
          signal: controller.signal,
          headers: {
            Accept: "application/json",
  ...
  async function fetchVideoById(idVideo: number) {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/Video/${idVideo}`, {
        signal: controller.signal,
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function fetchVideosReportados() {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/Video/reportados`, {
        signal: controller.signal,
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function aprobarVideo(idVideo: number) {
    loading.value = true;
    try {
      const response = await fetch(`http://localhost:5000/api/ReporteVideo/aprobar/${idVideo}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        }
  ...
  async function eliminarVideoPropio(idVideo: number): Promise<boolean> {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/Video/borrar-propio/${idVideo}`, {
        method: "DELETE",
        headers: {
