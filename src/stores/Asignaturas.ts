...
export const useAsignaturaStore = defineStore("asignatura", () => {
  ...
  async function fetchAllAsignaturas() {
    ...
    try {
      const response = await fetch("http://34.198.50.70:3000/api/Asignatura");
  ...
  async function fetchAsignaturasByCurso(idCurso: number) {
    ...
    try {
      const response = await fetch(`http://34.198.50.70:3000/api/Asignatura/curso/${idCurso}`);
  ...
  async function fetchAsignaturaById(idAsignatura: number): Promise<AsignaturaDTO | null> {
    ...
    try {
      const response = await fetch(`http://34.198.50.70:3000/api/Asignatura/${idAsignatura}`);
  ...
  async function updateAsignatura(asignatura: AsignaturaDTO): Promise<boolean> {
    ...
    try {
      const response = await fetch(`http://34.198.50.70:3000/api/Asignatura/${asignatura.idAsignatura}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
