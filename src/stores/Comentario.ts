...
export const useComentarioStore = defineStore("comentario", () => {
  ...
  async function fetchComentariosByVideoId(idVideo: number): Promise<ComentarioUI[]> {
    ...
    try {
      ...
      const response = await fetch(`https://academiqapi.retocsv.es/api/ComentarioVideo/video/${idVideo}`, {
  ...
  async function fetchComentariosReportados(): Promise<ComentarioUI[]> {
    ...
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/ComentarioVideo/reportados`, {
        headers: {
          "Accept": "application/json"
        }
      });
  ...
  async function createComentario(nuevoComentario: {
    ...
    try {
      ...
      const response = await fetch("https://academiqapi.retocsv.es/api/ComentarioVideo", {
        method: "POST",
        headers: { 
          "Content-Type": "application/json",
          "Accept": "application/json"
  ...
  async function reportarComentario(idComentario: number): Promise<boolean> {
    ...
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/ComentarioVideo/reportar/${idComentario}`, {
        method: "PUT",
        headers: {
          "Accept": "application/json"
        }
  ...
  async function quitarReporteComentario(idComentario: number): Promise<boolean> {
    ...
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/ComentarioVideo/quitar-reportes/${idComentario}`, {
        method: "PUT",
        headers: {
          "Accept": "application/json"
        }
  ...
  async function eliminarComentario(idComentario: number): Promise<void> {
    ...
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/ComentarioVideo/${idComentario}`, {
        method: "DELETE",
      });
  ...
  async function eliminarComentarioPropio(idComentario: number): Promise<boolean> {
    ...
    try {
      ...
      const response = await fetch(`https://academiqapi.retocsv.es/api/ComentarioVideo/borrar-propio/${idComentario}`, {
        method: "DELETE",
        headers: {
